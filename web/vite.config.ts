...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Browser Canary e2e-create-mrwbxboj-weshih-test",
        short_name: "Browser Canary e2e-create-mrwbxboj-weshih-test",
        description: "Browser Canary e2e-create-mrwbxboj-weshih-test — free forever",
        start_url: "/",
        display: "standalone",
